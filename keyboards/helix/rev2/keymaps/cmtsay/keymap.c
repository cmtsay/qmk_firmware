...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * | Ctrl | PgDn | Alt  | GUI  | Lower|Space |   =  |   -  |Space | Raise| Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      KC_LCTL,  KC_PGDN,  KC_LALT, KC_LGUI, LOWER,    KC_SPC,   KC_MS_BTN3, KC_MS_BTN3, KC_SPC,   RAISE,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, KC_PGUP, _______, _______, _______, _______, _______, _______, _______, _______, KC_MEDIA_FAST_FORWARD, KC__VOLDOWN, KC__VOLUP, KC_MEDIA_PLAY_PAUSE \
      ),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MEDIA_FAST_FORWARD        ,, KC__VOLDOWN, KC__VOLUP, KC_MEDIA_PLAY_PAUSE \
      ),
